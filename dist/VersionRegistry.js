...
exports.VersionRegistry = exports.bytes32toString = exports.string32 = void 0;
...
class VersionRegistry {
    constructor(web3provider, registryAddress, sendOptions = {}) {
        ...
        this.registryContract = new this.web3.eth.Contract(rif_relay_contracts_1.IVersionRegistry.abi, registryAddress);
    }
    async isValid() {
    ...
    async getVersion(id, delayPeriod, optInVersion = '') {
        ...
        const ver = versions.find((v) => !v.canceled &&
    ...
    async getAllVersions(id) {
        ...
        const cancelReasons = events
            .filter((e) => e.event === 'VersionCanceled')
            .reduce((set, e) => (Object.assign(Object.assign({}, set), { [e.returnValues.version]: e.returnValues.reason })), {});
        const found = new Set();
        return events
    ...
    async checkVersion(id, version, validateExists) {
        ...
        if ((versions.find((v) => v.version === version) != null) !==
            validateExists) {
