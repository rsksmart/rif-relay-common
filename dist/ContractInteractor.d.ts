...
export default class ContractInteractor {
    ...
    getActiveRelays(relayManagers: Set<string> | string[]): Promise<RelayManagerData[]>;
    ...
    walletFactoryDeployEstimateGasForInternalCall(request: DeployRequest, factory: string, domainHash: string, suffixData: string, signature: string, testCall?: boolean): Promise<number>;
